...
export default function SignIn() {
  ...
  if (error) {
    alert("You be thief: " + error.message+ ' ole. sign up if u no get account tho');
  } else {
    alert(`welcome back sexy`);
  ...
  if (error) {
    ...
    console.log(error.message);
                      ...
                      // testLogin();
  return (
    <div className="min-h-screen flex gap-12 items-center justify-center bg-blue-200">
